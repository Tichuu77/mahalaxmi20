...
const MobCard = memo(({
  ...
  return (
    <div
      className={`wcu__mob-card stagger-item${visible ? " on" : ""} s${index}`}
...
export function WhyChooseUsSection() {
  ...
  return (
    <section ref={sectionRef} id="why-choose-us" aria-label="Why Choose Mahalaxmi Infra" className="wcu revamp revamp--wcu refresh-v3 refresh-v3--wcu">
      ...
      <div className="section-inner">
        ...
        <div className={`wcu__top rv ${vis ? "on" : ""} d0`}>
          <div>
            ...
            <h2 id="wcu-heading" className="section-heading">
              Why Thousands<br /><em>Trust</em> <span>Mahalaxmi</span>
            </h2>
            <p className="section-sub">
              For over a decade, we've been building more than plots — we build
              confidence, community, and lasting value for families across Nagpur.
            </p>
          </div>
              ...
              {[
                ...
                <div key={heading}>
                  <div className="wcu__check-group-header">
                    ...
                    <h3 className={`wcu__check-group-label wcu__check-group-label--${gold ? "gold" : "green"}`}>
                      {heading}
                    </h3>
                  </div>
        ...
        <div className={`rv ${vis ? "on" : ""} d2`}>
          <div className="wcu__desk" aria-label="Our six pillars">
            <div className="wcu__pillars-header" aria-hidden="true">
            ...
            {reasons.map((r, i) => {
              ...
              return (
                <div key={r.title}>
                  ...
                  >
                    <span
                      className={`wcu__row-num wcu__row-num--${active ? "active" : "inactive"}`}
                      aria-hidden="true"
                    >
                    ...
                    <div className="wcu__row-icon-area">
                      <div className={`wcu__row-icon-wrap wcu__row-icon-wrap--${active ? "active" : "inactive"}`}>
                        <Icon
                          size={17}
                          className={`wcu__row-icon wcu__row-icon--${active ? "active" : "inactive"}`}
                          aria-hidden="true"
                        />
                      </div>
                      <div>
