  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 sm:bottom-8 sm:right-8">
      ...
      >
        ...
        {/* Button */}
        <span
          className="relative flex items-center justify-center w-14 h-14 rounded-full shadow-lg transition-all duration-300 group-hover:scale-110 group-hover:shadow-2xl sm:w-16 sm:h-16"
          style={{ background: "#30534A" }}
        >
          <svg
            className="w-7 h-7 text-white sm:w-8 sm:h-8"
            fill="currentColor"
            viewBox="0 0 24 24"
            aria-hidden="true"
            focusable="false"
