      ...
      <div className="section-inner">
        <div className={`rv ${vis ? "on" : ""} d0 mb-section`}>
          ...
          <h2 id="contact-heading" className="section-heading">
            Let's <em>Find</em> Your<br />
            <span>Dream Plot</span>
          </h2>
          <p className="section-sub">
            Reach out for a site visit, price list, or any query. Our team
        ...
        <div className="contact__layout">
          ...
          <div className={`rv ${vis ? "on" : ""} d1 contact__info`}>
                ...
                return (
                  ...
                  >
                    <div className="contact-card__inner">
                      <div className={`contact-card__corner contact-card__corner--${c.dark ? "dark" : "light"}`} />
                      ...
                      <div>
                        ...
                        {c.values.map((v, i) => (
                          <p
                            key={i}
                            className={`contact-card__value contact-card__value--${c.dark ? "dark" : "light"}`}
                          >
                            {v}
                          </p>
                        ))}
            ...
            <div className="contact__badges" aria-label="Certifications">
            ...
            {status === "success" ? (
              <div className="contact__success" role="status" aria-live="polite">
                <div className="contact__success-icon">
                  <CheckCircle2 size={26} className="icon-gold" aria-hidden="true" />
                </div>
